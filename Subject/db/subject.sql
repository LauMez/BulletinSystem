...
VALUES (UUID_TO_BIN("332d4136-09be-4eaf-81d4-e073a9ca53f7"), UUID_TO_BIN("42312ccf949a4396b858d41bdf235736"), 'matematica');
...
INSERT INTO Subject_Schedule (scheduleID, subjectID, day, entry_schedule, finish_schedule)
VALUES (UUID_TO_BIN("20d4dfdf-45a7-4f3a-ae8e-6384fd809d59"), UUID_TO_BIN("332d4136-09be-4eaf-81d4-e073a9ca53f7"), 'jueves', '15:30', '17:30');

INSERT INTO Subject (subjectID, courseID, name)
VALUES (UUID_TO_BIN("ef8ee06e-5ef0-479f-98de-d1705bf4063d"), UUID_TO_BIN("42312ccf949a4396b858d41bdf235736"), 'Ingles');
INSERT INTO Subject_Schedule (scheduleID, subjectID, day, entry_schedule, finish_schedule)
